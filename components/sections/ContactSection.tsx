  ...
  return (
    <section className="bg-primary py-24 md:py-32">
      <div className="mx-auto max-w-[1280px] px-5 text-center md:px-16">
        <h2 className="headline-md text-on-primary mb-4">
          Ready to Start Your Project?
        </h2>
        <p className="body-lg text-on-primary/80 mx-auto mb-8 max-w-xl">
          Whether you are furnishing a home or outfitting an office, we are
          here to help you find the perfect pieces for your space.
        </p>
        <a
          href="/contact"
