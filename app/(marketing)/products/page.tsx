    ...
    <>
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 text-center md:px-16">
          ...
          <p className="body-lg mx-auto mt-4 max-w-2xl text-white/70 text-lg">
      ...
      <section className="bg-surface py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-5 md:px-16">
          <div className="mx-auto mb-16 max-w-xl text-center">
            <h2 className="font-sans text-4xl text-primary mb-4">
      ...
      <section className="bg-surface-container py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-5 md:px-16">
          <div className="mx-auto mb-16 max-w-xl text-center">
            <h2 className="font-sans text-4xl text-primary mb-4">Beyond Furniture</h2>
            <p className="body-md text-on-surface-variant">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
              <div
                key={service.title}
                className="rounded-lg bg-surface p-8 shadow-md transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg border border-outline-variant"
              >
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded bg-primary-container text-white bg-primary">
                  {service.icon}
                </div>
